...
function getMockResponse(prompt: string): string {
  if (prompt.includes('简历结构化提取助手')) {
    return JSON.stringify({
      ...
      experience: [
        '百度在线网络技术（北京）有限公司  AI健康助手·产品经理实习生  2024.03–2024.07\n• 大模型竞品评测：设计医疗Query评估集及可用率、优良率等评分口径，完成自家产品与文心一言等11款产品评测\n• 兜底体验优化：梳理退款/订单/客服三类高频失败意图链路，参与分层兜底方案设计；A/B实验好评率由88.47%提升至89.19%\n• 医疗数据洞察：独立负责《量药采医》系列行业研究5期，单期处理约10万条搜索/问诊数据',
      ],
      projects: [
        '新加坡国立大学校外合作课题 | 全球碳排放驱动因素分析  2022.12–2023.02\n使用R收集并清洗200+国家近10年碳排放记录；结合ARIMA、随机森林回归完成趋势预测和驱动因素识别',
        '校级科研训练 | 社交媒体视域下新冠学术成果传播力研究  2022.04–2023.04\n使用Python爬取约45万条数据，通过聚类与多元线性回归定位传播力影响因素',
      ],
      skills: [
        'AI/产品：大模型评估集与指标设计、竞品满足度评测、用户需求分析、A/B实验分析、Prompt Engineering、RAG基础应用',
