      ...
      rewriteSuggestions: [
        {
          ...
          suggestion: '主导构建200条医疗Query评估集，设计可用率/优良率双层评分口径；对自家产品及11款主流大模型产品（含Kimi、夸克、Perplexity）完成系统性评测，自家产品可用率99%、优良率72%，处于第一梯队，结果直接支持模型迭代排期。',
        },
        {
...
• **兜底体验优化｜** 梳理退款/订单/客服三类高频失败意图链路，参与分层兜底方案设计；主导A/B实验指标口径制定与数据归因，实验组好评率由88.47%提升至89.19%（+0.72pct），服务转化率相对提升41.65%，点踩量下降4.91%。

• **医疗数据洞察｜** 独立负责《量药采医》系列行业研究5期，单期处理约10万条搜索/问诊数据；建立疾病同义词词包统一检索口径，从趋势、人群、意图、疾病–药物共现等6+维度识别需求，支持内容供给与产品策略。

• **Multi-agent指标建设｜** 参与multi-agent健康助手核心指标与看板搭建维护，完成实验分析及口径核对，支持功能迭代与效果跟踪。
