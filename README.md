...
1. 进入**岗位列表**，查看 10+ 条演示岗位
2. 点击任一岗位进入**详情页**
3. 切换到「匹配分析」Tab，运行 AI 匹配，查看匹配度、优势、能力缺口和面试追问
4. 切换到「生成简历」Tab，选择量化版或脱敏版，一键生成定制简历
5. 下载 Word 简历
6. 返回**投递看板**，查看岗位状态分布和求职漏斗转化率
7. 进入**导入招聘帖**，粘贴小红书分享文本，体验 AI 结构化解析全流程
